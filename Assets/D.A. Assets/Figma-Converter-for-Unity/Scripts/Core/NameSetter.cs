...
namespace DA_Assets.FCU
{
    ...
    public class NameSetter : MonoBehaviourBinder<FigmaConverterUnity>
    {
        ...
        public void SetNames(FObject child)
        {
            ...
            child.Data.UssClassName = GetUssClassName(child);
        }
        ...
        public string GetUssClassName(FObject fobject)
        {
        ...
        private string GetFcuName(FObject fobject, FcuNameType nameType)
        {
