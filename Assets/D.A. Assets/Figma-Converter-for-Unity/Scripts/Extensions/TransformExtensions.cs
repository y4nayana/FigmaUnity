...
namespace DA_Assets.FCU.Extensions
{
    public static class TransformExtensions
    {
        ...
        public static float GetAngleFromMatrix(this FObject fobject, FigmaConverterUnity fcu)
        {
            ...
            {
                fcu.Log($"GetFigmaRotationAngle | {fobject.Data.NameHierarchy} | wrong relative transform.", FcuLogType.Error);
                return 0;
            }
            else
            {
            ...
            fcu.Log($"GetFigmaRotationAngle | {fobject.Data.NameHierarchy} | rotDeg: {rotDeg}\nb: {b}\na: {a}\nrotRad: {rotRad}");
        ...
        public static float GetAngleFromField(this FObject fobject, FigmaConverterUnity fcu)
        {
            ...
            if (fobject.Rotation != null)
            {
                ...
                fcu.Log($"GetFigmaRotationAngle | 1 | {fobject.Data.NameHierarchy} | rotRad: {rotRad}");
            }
            else
            {
                return 0;
